                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <small class="text-muted">
                                    Added holidays will automatically be blocked in the booking calendar.
                                </small>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse($holidays as $holiday)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <form action="{{ route('admin.holidays.delete', $holiday->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center text-muted py-4">No holidays added
                                                    yet.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            <form action="{{ route('admin.holidays.storeBulk') }}" method="POST">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="manualDates" class="form-control"
